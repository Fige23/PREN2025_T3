...
source/com/%.o: ../source/com/%.c source/com/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-com

clean-source-2f-com:
	-$(RM) ./source/com/uart0.d ./source/com/uart0.o ./source/com/uart1.d ./source/com/uart1.o

.PHONY: clean-source-2f-com
